...
function PlayButtonComponent({id}: PlayButtonProps): JSX.Element {
  ...
  return (
    <button data-testid="play-button" onClick={handleClick} className="btn btn--play film-card__button" type="button">
      <svg data-testid="play-img" viewBox="0 0 19 19" width="19" height="19">
